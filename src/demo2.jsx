    ...
    render() {
        return (
            <React.Fragment>
                ...
                <Form {...formProps}>
                    {
                        ({ values, errors, touched, isSubmittting, handleChange, handleBlur, onSubmit }) => {
                            return (
                                <div>
                                    <div className="form-item">
                                        <label htmlFor="">姓名</label>
                                        <input type="text" value={values.name} onChange={handleChange("name")} onBlur={handleBlur("name")} />
                                        <span className="error-info">{touched.name && errors.name}</span>

                                    </div>
                                    <div className="form-item">
                                        <label htmlFor="">邮箱</label>
                                        <input type="text" value={values.email} onChange={handleChange("email")} onBlur={handleBlur("email")} />
                                        <span className="error-info">{touched.email && errors.email}</span>
                                    </div>

                                    <div className="form-item">
                                        <label htmlFor="">手机号</label>
                                        <input type="text" value={values.phone} onChange={handleChange("phone")} onBlur={handleBlur("phone")} />
                                    ...
                                    <div className="form-item">
                                        ...
                                        <input type="password" value={values.confirm} onChange={handleChange("confirm")} onBlur={handleBlur("confirm")} />
